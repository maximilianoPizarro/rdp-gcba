...
public class UserDaoImpl extends AbstractDao<Integer, User> implements UserDao {
	...
	public User existeUsuario(String user, String pass) throws HibernateException {
		User respuesta=null;
		try {
		respuesta=(User) getEntityManager()
				.createQuery("SELECT u FROM User u Where u.ssoId LIKE :user AND u.password LIKE :pass")
				.setParameter("user",user)
				.setParameter("pass",pass).getSingleResult();

		if(respuesta!=null){
			initializeCollection(respuesta.getUserProfiles());
		}
